...
Level4::Level4(){
    levnum = 4;
    rb1 = true;//yes default is random
    rb2 = true;
    seqCt1 = 0;
    seqCt2 = 0;
    seqCt1_int = 0;
...
void Level4::aBS(std::string filename,int id){
    string s;
    if (id == 1){
...
shared_ptr<Block> Level4::Blockg(std::shared_ptr<Player> pler){
